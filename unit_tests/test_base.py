...
def capture_logging():
    ...
    logger = logging.getLogger('app.crawling')
    level = logger.level
...
class TestBaseCrawling(unittest.TestCase):
    ...
    def test_redirect(self):
        ...
        with capture_logging() as messages:
            self.create_crawler([url], max_redirect=1)
            self.crawl()
            self.assertDoneCount(2)
    ...
    def test_max_tasks(self):
        ...
        self.create_crawler([home], max_tasks=2)
        self.crawl()
    ...
    def test_max_tries(self):
        ...
        with capture_logging() as messages:
            self.create_crawler([self.app_url])
            self.crawl()
        ...
        n_tries = 0
        with capture_logging() as messages:
            self.create_crawler([self.app_url], max_tries=1)
            self.crawl()
        self.assertDoneCount(1)
    ...
    #         self.create_crawler([self.app_url + url])
    #         self.crawl()
    ...
    def test_non_html(self):
        ...
        self.create_crawler([self.app_url + '/xml'])
        self.crawl()
        ...
        self.create_crawler([self.app_url + '/image'])
        self.crawl()
